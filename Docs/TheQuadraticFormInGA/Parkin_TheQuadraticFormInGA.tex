...
simultaneously representative of both a dual and direct quadric, which are not necessarily the
same peice of the geometry.\footnote{A dual quadric is directly represented by its dual, and
...
to transition between dual and direct quadrics, we see that an $(n+1-k)$-dimensional
quadric surface may be fit to $m-k$ points, from which it is more likely that we'll
generate a linearly independent set.
