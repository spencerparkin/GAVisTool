...
that the double spherical reflections product a diolation in each case.
...
Transversions are, in my opinion, most certainly the odd duck in the family of basic
transformation versors of the conformal model.
