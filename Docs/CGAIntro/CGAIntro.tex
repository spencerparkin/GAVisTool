...
% prove that lines and flat-points generalize planar reflections to
% hyper-planes of lower dimension.  can we do something similar
% with spherical reflections?  when are two spheres orthogonal?
...
Transversions are the strange duck in the family of basic
...
If, however, we can show that a transversion may be described by a different
