...
reason that every possible blade-valued function of blades taken from $\G$ must produce
a result of geometric significance in relation to the blades given to the function.}
...
% every round is the outer product of an $n$-dimensional dual round with
% a specific $m<=n$ dimensional dual flat.  if x is in the plane, the problem
% is easy.  if x is not, the problem is a bit harder.
