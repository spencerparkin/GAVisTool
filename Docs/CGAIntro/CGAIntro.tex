...
always be used to decispher the result of a geometric operation.
...
How exactly this can be useful remains to be seen.
...
about a given geometry should be answerable through some easy calculation
