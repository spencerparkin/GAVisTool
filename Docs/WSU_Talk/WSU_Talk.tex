...
\alert{Question}: Let $N_0$, $N_1$ and $N_2$ each \alert{dually} represent 3 sides of a non-degenerate
tetrahedron.  Let $S$ \alert{dually} represent the sphere determined by this tetrahedron.  What is
the \alert{dual} plane $N_3$ forming the remaining side of the tetrahedron?
