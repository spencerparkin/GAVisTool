...
There are undoubtedly more uses of equation \eqref{equ_highlevel_equation},
but let us now turn our attention to the construction of certain classes of quadrics.

\section{Quadric 2-Blades}
...
to these four points.  Whatever the case may be, it clear from equation
\eqref{equ_quadric_twoblade_expanded} that the quadric $B$ contains the intersection
